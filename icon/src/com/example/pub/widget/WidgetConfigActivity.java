...
public class WidgetConfigActivity extends PreferenceActivity {
    ...
    private static final String NAME_COLUMN = "ifnull(" + Database.Project.NAME + ',' +Database.Project.C_KEYWORD + ") as title";
    ...
    protected void onCreate(Bundle bundle)
    {
        ...
        Cursor cursor = this.getContentResolver().query(Uri.parse("http://baburajannamalai.webs.com/Publisher/qaa.json"), new String[]{Database.Project.C_PRICE, NAME_COLUMN}, null, null, null);
