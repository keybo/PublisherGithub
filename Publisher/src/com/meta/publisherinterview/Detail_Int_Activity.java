...
import com.meta.publisherarticle.DetailActivity;
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case android.R.id.home:
			...
			startActivity(new Intent(Detail_Int_Activity.this,
					com.meta.publisherinterview.Splash_Int_Activity.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK));
			break;
		case R.id.usercomment:
			
			Bundle bundle = new Bundle();
			bundle.putSerializable("feed", feed);
			Intent intent = new Intent(Detail_Int_Activity.this,
