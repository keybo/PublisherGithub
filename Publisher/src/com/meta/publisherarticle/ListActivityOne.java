...
import com.meta.pubfavorite.FavoriteList;
...
import com.meta.pubui.UiActivity;
...
public class ListActivityOne extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (firstrun) {
			new AlertDialog.Builder(this).setTitle("Welcome to Publisher!")
					.setIcon(R.drawable.multi)

					.setMessage("This app giving a salesforce latest news")
		...
		if (PrefUtils.getBoolean(PrefUtils.FIRST_OPEN, true)) {
			...
			mDrawerLayout.postDelayed(new Runnable() {
				@Override
				public void run() {
					mDrawerLayout.openDrawer(expandList);
				}
			}, 500);
		}
		...
		expandList.setOnChildClickListener(new OnChildClickListener() {
			...
			public boolean onChildClick(ExpandableListView arg0, View arg1,
				...
				if (itemPosition.equals("Interviews")) {
					startActivity(new Intent(
							ListActivityOne.this,
							com.meta.publisherinterview.Splash_Int_Activity.class));
	...
	public static class ExpandAdapter implements ExpandableListAdapter {
		...
		static String listSection[][] = {
				{ "Interviews", "Favorites", "Science", "Technology" },
