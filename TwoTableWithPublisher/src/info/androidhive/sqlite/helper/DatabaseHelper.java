...
public class DatabaseHelper extends SQLiteOpenHelper
{
	...
	private static final String CREATE_TABLE_ARTICLE = "CREATE TABLE "
			...
			+ " TEXT," + ART_TITLE + " TEXT," + ART_AUTHOR + " TEXT," + ART_TIME + " DATETIME," + KEY_CREATED_AT
			+ " DATETIME" + ")";
	...
	// insert row
	long tag_id = db.insert(TABLE_ARTICLE, null, values);
	...
	public List<JSONItem> getAllArticleTags() 
	{
		...
		if (c.moveToFirst())
		{
			do 
			{
				...
				//t.setImage(c.getColumnIndex(ART_IMAGE));
