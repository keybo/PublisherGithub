...
{
	private static final String IntURL = "http://www.baburajannamalai.webs.com/Publisher/qaa.json";
	...
	private void startListActivity(JSONFeed feed)
	{
		...
		Bundle widBundle = new Bundle();
		bundle.putSerializable("feed", feed);
		Intent widIntent = new Intent(Splash_Int_Activity.this, List_Int_Activity.class);
		widIntent.putExtras(widBundle);
		startActivity(intent);
