...
public class FeedData {
	...
	public static final String AUTHORITY = "com.example.metaprovider.provider.FeedData";
	...
	public static class FeedColumns implements BaseColumns {
		...
		public static final String[][] COLUMNS = new String[][] {
				{ _ID, TYPE_PRIMARY_KEY }, { URL, TYPE_TEXT_UNIQUE },
				{ NAME, TYPE_TEXT }, { IS_GROUP, TYPE_BOOLEAN },
				{ GROUP_ID, TYPE_EXTERNAL_ID },
				{ LAST_UPDATE, TYPE_DATE_TIME },
				{ REAL_LAST_UPDATE, TYPE_DATE_TIME },
				{ RETRIEVE_FULLTEXT, TYPE_BOOLEAN }, { ICON, "BLOB" },
				{ ERROR, TYPE_TEXT }, { PRIORITY, TYPE_INT },
				{ FETCH_MODE, TYPE_INT } };

		public static final Uri CONTENT_URI = Uri.parse(CONTENT_AUTHORITY
				+ "/feeds");

		public static final Uri GROUPED_FEEDS_CONTENT_URI = Uri
				.parse(CONTENT_AUTHORITY + "/grouped_feeds");
		...
		public static final Uri GROUPS_CONTENT_URI = Uri
				.parse(CONTENT_AUTHORITY + "/groups");
	...
	public static class FilterColumns implements BaseColumns {
		...
		public static final String[][] COLUMNS = new String[][] {
				{ _ID, TYPE_PRIMARY_KEY }, { FEED_ID, TYPE_EXTERNAL_ID },
				{ FILTER_TEXT, TYPE_TEXT }, { IS_REGEX, TYPE_BOOLEAN },
	...
	public static class EntryColumns implements BaseColumns {
		...
		public static final String[][] COLUMNS = new String[][] {
				{ _ID, TYPE_PRIMARY_KEY }, { FEED_ID, TYPE_EXTERNAL_ID },
				{ TITLE, TYPE_TEXT }, { ABSTRACT, TYPE_TEXT },
				{ MOBILIZED_HTML, TYPE_TEXT }, { DATE, TYPE_DATE_TIME },
				{ IS_READ, TYPE_BOOLEAN }, { LINK, TYPE_TEXT },
				{ IS_FAVORITE, TYPE_BOOLEAN }, { ENCLOSURE, TYPE_TEXT },
				{ GUID, TYPE_TEXT }, { AUTHOR, TYPE_TEXT } };

		public static final Uri CONTENT_URI = Uri.parse(CONTENT_AUTHORITY
				+ "/entries");
		public static final Uri FAVORITES_CONTENT_URI = Uri
				.parse(CONTENT_AUTHORITY + "/favorites");
		...
		public static Uri PARENT_URI(String path) {
			return Uri.parse(CONTENT_AUTHORITY
		...
		public static final String WHERE_NOT_FAVORITE = "("
				+ EntryColumns.IS_FAVORITE + Constants.DB_IS_NULL
				+ Constants.DB_OR + EntryColumns.IS_FAVORITE
				+ Constants.DB_IS_FALSE + ')';
	}
	...
	public static class TaskColumns implements BaseColumns {
		...
		public static final String[][] COLUMNS = new String[][] {
				{ _ID, TYPE_PRIMARY_KEY }, { ENTRY_ID, TYPE_EXTERNAL_ID },
				{ IMG_URL_TO_DL, TYPE_TEXT }, { NUMBER_ATTEMPT, TYPE_INT } };
